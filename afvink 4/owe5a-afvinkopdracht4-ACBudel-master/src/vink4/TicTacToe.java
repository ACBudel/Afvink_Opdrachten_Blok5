    ...
    public void actionPerformed(ActionEvent event) {
        ...
        for (int x = 0; x < XAS; x++) {
            for (int y = 0; y < YAS; y++) {
                ...
                else if (beurt%2==1 && buttonPressed==button[x][y]){
                    button[x][y].setIcon(kruisje);
                    //beurt++;
                }
                else if(beurt%2==0 && buttonPressed==button[x][y]){
        ...
        else if (button[0][0].getIcon()==kruisje && button[0][1].getIcon()==kruisje && button[0][2].getIcon()==kruisje){
            JOptionPane.showMessageDialog(null, "Kruisje wint!");
            System.exit(0);
        }
        else if (button[0][0].getIcon()==kruisje && button[1][1].getIcon()==kruisje && button[2][2].getIcon()==kruisje){
            JOptionPane.showMessageDialog(null, "Kruisje wint!");
            System.exit(0); 
        }
        else if (button[1][0].getIcon()==kruisje && button[1][1].getIcon()==kruisje && button[1][2].getIcon()==kruisje){
            JOptionPane.showMessageDialog(null, "Kruisje wint!");
            System.exit(0);
        }
        else if (button[2][0].getIcon()==kruisje && button[2][1].getIcon()==kruisje && button[2][2].getIcon()==kruisje){
            JOptionPane.showMessageDialog(null, "Kruisje wint!");
            System.exit(0);
        }
        else if (button[0][1].getIcon()==kruisje && button[1][1].getIcon()==kruisje && button[2][1].getIcon()==kruisje){
            JOptionPane.showMessageDialog(null, "Kruisje wint!");
            System.exit(0);
        }
        else if (button[0][2].getIcon()==kruisje && button[1][2].getIcon()==kruisje && button[2][2].getIcon()==kruisje){
            JOptionPane.showMessageDialog(null, "Kruisje wint!");
            System.exit(0);
        }
        else if (button[0][2].getIcon()==kruisje && button[1][1].getIcon()==kruisje && button[2][0].getIcon()==kruisje){
            JOptionPane.showMessageDialog(null, "Kruisje wint!");
            System.exit(0);
        }
        else if (button[0][0].getIcon()==rondje && button[1][0].getIcon()==rondje && button[2][0].getIcon()==rondje){
            JOptionPane.showMessageDialog(null, "Rondje wint!");
            System.exit(0);
        }
        else if (button[0][0].getIcon()==rondje && button[0][1].getIcon()==rondje && button[0][2].getIcon()==rondje){
            JOptionPane.showMessageDialog(null, "Rondje wint!");
            System.exit(0);
        }
        else if (button[0][0].getIcon()==rondje && button[1][1].getIcon()==rondje && button[2][2].getIcon()==rondje){
            JOptionPane.showMessageDialog(null, "Rondje wint!");
            System.exit(0); 
        }
        else if (button[1][0].getIcon()==rondje && button[1][1].getIcon()==rondje && button[1][2].getIcon()==rondje){
            JOptionPane.showMessageDialog(null, "Rondje wint!");
            System.exit(0);
        }
        else if (button[2][0].getIcon()==rondje && button[2][1].getIcon()==rondje && button[2][2].getIcon()==rondje){
            JOptionPane.showMessageDialog(null, "Rondje wint!");
            System.exit(0);
        }
        else if (button[0][1].getIcon()==rondje && button[1][1].getIcon()==rondje && button[2][1].getIcon()==rondje){
            JOptionPane.showMessageDialog(null, "Rondje wint!");
            System.exit(0);
        }
        else if (button[0][2].getIcon()==rondje && button[1][2].getIcon()==rondje && button[2][2].getIcon()==rondje){
            JOptionPane.showMessageDialog(null, "Rondje wint!");
            System.exit(0);
        }
        else if (button[0][2].getIcon()==rondje && button[1][1].getIcon()==rondje && button[2][0].getIcon()==rondje){
            JOptionPane.showMessageDialog(null, "Rondje wint!");
            System.exit(0);
        }
        else if(beurt%2==0){
                message("Kruisje aan de beurt");
        }
        else if(beurt%2==1){
            message("Rondje aan de beurt");
        }
